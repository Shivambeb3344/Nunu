...
from concurrent.futures import ThreadPoolExecutor as BRANDSHIVAM
from string import * 
...
\033[92;1m➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ SHIVAM X BEPEYYY ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\033[33m【✪】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤
\033[1;32m【✪】Cʀᴇᴀᴛᴇᴅ Bʏ   ✯  SHIVAM XWD 
\033[1;32m【✪】FB Gʀᴏᴜᴘ     ✯  CUMING SOON
\033[1;32m【✪】Oɴ Gɪᴛʜᴜʙ    ✯  SHIVAMXWD7
...
def BRAND():   
    ...
    print(f'\033[1;32m[F]\033[1;32mFollow Me On Facebook ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://t.me/+Ba3-ZiDmXmE3ZTg1/')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/shivamxwd88/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SHIVAM(allkey)
...
def method_crack():
    global methods
    clear()
    print(f'\033[1;32m[1]\033[1;32mMethod {1}')
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        self.file = input('\033[1;32mPut File Name : ')
        try:
